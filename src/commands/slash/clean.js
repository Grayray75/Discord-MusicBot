...
const command = new SlashCommand()
    ...
    .addIntegerOption((option) => option.setName('number').setDescription('Number of messages to delete.').setMinValue(2).setMaxValue(100).setRequired(false))
        ...
        interaction.channel.messages
            ...
            .then((messages) => {
                ...
                interaction.channel.bulkDelete(botMessages, true).then(async (deletedMessages) => {
                    ...
                    await interaction.editReply({ embeds: [client.createEmbed(`:white_check_mark: | Deleted ${botMessages.length} bot messages`)] });
                    setTimeout(() => {
