module.exports = {
    ...
    token: process.env.DISCORD_CLIENT_TOKEN || '', //- Bot's Token
    ...
    disconnectTime: 120000, //- How long should the bot wait before disconnecting from the voice channel (in miliseconds). Set to 1 for instant disconnect.
    ...
    cookieSecret: 'CodingWithSudhan is epic 75', //- Cookie Secret
    ...
    nodes: [
        {
            ...
            retryDelay: 250, //- Delay between reconnect attempts if connection is lost.
            secure: false //- Can be either true or false. Only use true if ssl is enabled!
        }
    ],
    embedColor: '#881ac8', //- Color of the embeds, hex supported
    presence: {
